...
class SigningMode(Enum):
    ...
    # CHIP-0002 signs the result of sha256tree(cons("SSDCoin Signed Message", message)) using the
    ...
    # Standard BLS signatures used by SSDCoin use the BLS message augmentation scheme
