...
from ssdcoin.server.outbound_message import NodeType, make_msg, Message
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        ...
        for sp in sps:
            ...
            required_iters: uint64 = calculate_iterations_quality(
                ...
                sp.difficulty,
                new_proof_of_space.sp_hash,
                new_proof_of_space.proof.staking_coefficient,
            )
    ...
    async def new_signage_point(
        ...
        try:
            ...
            # staking
            response: farmer_protocol.FarmerStakingCoefficients = await peer.call_api(
                FullNodeAPI.request_staking_coefficients,
                farmer_protocol.RequestStakingCoefficients(
    ...
    # staking
    @api_request()
    async def respond_staking_coefficients(self, request: farmer_protocol.FarmerStakingCoefficients):
