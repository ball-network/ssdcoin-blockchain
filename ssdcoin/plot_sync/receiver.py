...
from ssdcoin.plot_sync.delta import Delta, PathListDelta, PlotListDelta
from ssdcoin.plot_sync.exceptions import (
...
from ssdcoin.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
from ssdcoin.plotting.util import HarvestingMode
...
from ssdcoin.util.ints import int16, uint32, uint64
from ssdcoin.util.misc import get_list_or_len
...
class Receiver:
    _connection: WSSSDCoinConnection
    _current_sync: Sync
    _last_sync: Sync
