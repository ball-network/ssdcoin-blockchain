...
from ssdcoin.plot_sync.util import Constants
from ssdcoin.plotting.manager import PlotManager
from ssdcoin.plotting.util import HarvestingMode, PlotInfo
...
class Sender:
    ...
    _connection: Optional[WSSSDCoinConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSSSDCoinConnection) -> None:
