...
from ssdcoin.plotters.bladebit import get_bladebit_install_info, plot_bladebit
from ssdcoin.plotters.chiapos import get_chiapos_install_info, plot_ssdcoin
from ssdcoin.plotters.madmax import get_madmax_install_info, plot_madmax
...
def call_plotters(root_path: Path, args):
    # Add `plotters` section in SSDCOIN_ROOT.
    ssdcoin_root_path = root_path
    ...
    if not os.path.exists(root_path):
        print(f"Creating plotters folder within SSDCOIN_ROOT: {root_path}")
        try:
            os.mkdir(root_path)
        except Exception as e:
    ...
    if args.plotter is None:
        ...
        plot_ssdcoin(args, ssdcoin_root_path)
    elif args.plotter == "madmax":
        plot_madmax(args, ssdcoin_root_path, root_path)
    elif args.plotter == "bladebit":
        plot_bladebit(args, ssdcoin_root_path, root_path)
    elif args.plotter == "version":
        show_plotters_version(ssdcoin_root_path)
