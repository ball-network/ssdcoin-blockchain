...
DEFAULT_CONSTANTS = ConsensusConstants(
    ...
    DIFFICULTY_CONSTANT_FACTOR=uint128(2**60),
    DIFFICULTY_STARTING=uint64(16),
    ...
    # June 2024
    HARD_FORK_HEIGHT=uint32(1537800),
    HARD_FORK_FIX_HEIGHT=uint32(1537800),
    # June 2027
    PLOT_FILTER_128_HEIGHT=uint32(6583560),
    # June 2030
    PLOT_FILTER_64_HEIGHT=uint32(11633928),
    # June 2033
    PLOT_FILTER_32_HEIGHT=uint32(16684296),
)
