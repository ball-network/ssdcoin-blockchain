...
from ssdcoin.rpc.rpc_server import default_get_connections
from ssdcoin.server.outbound_message import NodeType
from ssdcoin.simulator.block_tools import BlockTools
from ssdcoin.simulator.simulator_protocol import FarmNewBlockProtocol, GetAllCoinsProtocol, ReorgProtocol
...
class FullNodeSimulator(FullNodeAPI):
    ...
    async def farm_blocks_to_puzzlehash(
        ...
        is to receive SSD at an address.
