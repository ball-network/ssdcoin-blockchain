...
from ssdcoin.consensus.block_rewards import calculate_base_farmer_reward, calculate_pool_reward, calculate_community_reward
from ssdcoin.consensus.blockchain_interface import BlockchainInterface
from ssdcoin.consensus.coinbase import create_farmer_coin, create_pool_coin, create_puzzlehash_for_pk, create_community_coin
...
from ssdcoin.simulator.time_out_assert import time_out_assert_custom_interval
...
from ssdcoin.wallet.puzzles.rom_bootstrap_generator import GENERATOR_MOD
...
def load_block_list(
    ...
    for full_block in block_list:
        ...
        required_iters: uint64 = calculate_iterations_quality(
            ...
            uint64(difficulty),
            sp_hash,
            full_block.reward_chain_block.proof_of_space.staking_coefficient,
        )
