...
from ssdcoin.consensus.block_creation import create_unfinished_block, unfinished_block_to_full_block
...
from ssdcoin.plotting.create_plots import PlotKeys, create_plots
from ssdcoin.plotting.manager import PlotManager
from ssdcoin.plotting.util import (
    Params,
    PlotRefreshEvents,
    PlotRefreshResult,
...
from ssdcoin.simulator.wallet_tools import WalletTool
...
from ssdcoin.types.blockchain_format.program import INFINITE_COST, Program
...
from ssdcoin.util.ssl_check import fix_ssl
from ssdcoin.util.timing import adjusted_timeout, backoff_times
...
from ssdcoin.wallet.puzzles.load_clvm import load_serialized_clvm_maybe_recompile

GENERATOR_MOD: SerializedProgram = load_serialized_clvm_maybe_recompile(
    "rom_bootstrap_generator.clsp", package_or_requirement="ssdcoin.consensus.puzzles"
)

DESERIALIZE_MOD = load_serialized_clvm_maybe_recompile(
    "chialisp_deserialisation.clsp", package_or_requirement="ssdcoin.consensus.puzzles"
)
        ...
        try:
            if self.local_keychain:
                ...
                keychain_proxy = await connect_to_keychain_and_validate(
                    self.root_path, self.log, user="testing-1.8.0", service="ssdcoin-testing-1.8.0"
                )
            ...
            if len(self.pool_pubkeys) == 0 or len(self.farmer_pubkeys) == 0:
                raise RuntimeError("Keys not generated. Run `ssd keys generate`")
        ...
        try:
            if plot_keys is None:
                ...
                if pool_contract_puzzle_hash is None:
                    ...
                    pool_address = encode_puzzle_hash(pool_contract_puzzle_hash, "ssd")
    ...
    def get_pospaces_for_challenge(
        ...
        for plot_info in self.plot_manager.plots.values():
            ...
            if passes_plot_filter(prefix_bits, plot_id, challenge_hash, signage_point):
                ...
                coefficient = uint64(STAKE_PER_COEFFICIENT)
...
def load_block_list(
    ...
    for full_block in block_list:
        ...
        required_iters: uint64 = calculate_iterations_quality(
            ...
            uint64(difficulty),
            sp_hash,
            full_block.reward_chain_block.proof_of_space.stake_coefficient,
        )
