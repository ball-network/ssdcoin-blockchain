...
from ssdcoin.cmds.init_funcs import init
from ssdcoin.consensus.constants import ConsensusConstants
from ssdcoin.daemon.server import WebSocketServer, daemon_launch_lock_path
...
from ssdcoin.protocols.shared_protocol import Capability, capabilities
from ssdcoin.seeder.crawler import Crawler
from ssdcoin.seeder.crawler_api import CrawlerAPI
from ssdcoin.seeder.dns_server import DNSServer, create_dns_server_service
from ssdcoin.seeder.start_crawler import create_full_node_crawler_service
from ssdcoin.server.outbound_message import NodeType
from ssdcoin.server.start_farmer import create_farmer_service
from ssdcoin.server.start_full_node import create_full_node_service
from ssdcoin.server.start_harvester import create_harvester_service
from ssdcoin.server.start_introducer import create_introducer_service
from ssdcoin.server.start_service import Service
from ssdcoin.server.start_timelord import create_timelord_service
from ssdcoin.server.start_wallet import create_wallet_service
from ssdcoin.simulator.block_tools import BlockTools, test_constants
from ssdcoin.simulator.full_node_simulator import FullNodeSimulator
from ssdcoin.simulator.keyring import TempKeyring
from ssdcoin.simulator.ssl_certs import get_next_nodes_certs_and_keys, get_next_private_ca_cert_and_key
from ssdcoin.simulator.start_simulator import create_full_node_simulator_service
from ssdcoin.ssl.create_ssl import create_all_ssl
from ssdcoin.timelord.timelord import Timelord
from ssdcoin.timelord.timelord_api import TimelordAPI
from ssdcoin.timelord.timelord_launcher import VDFClientProcessMgr, find_vdf_client, spawn_process
from ssdcoin.types.blockchain_format.sized_bytes import bytes32
from ssdcoin.types.peer_info import UnresolvedPeerInfo
from ssdcoin.util.bech32m import encode_puzzle_hash
from ssdcoin.util.config import config_path_for_filename, load_config, lock_and_load_config, save_config, set_peer_info
from ssdcoin.util.db_wrapper import generate_in_memory_db_uri
from ssdcoin.util.ints import uint16
from ssdcoin.util.keychain import bytes_to_mnemonic
from ssdcoin.util.lock import Lockfile
from ssdcoin.util.misc import SignalHandlers
...
async def setup_crawler(
    ...
    service_config["other_peers_port"] = 23433
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["ssd_spam_amount"] = ssd_spam_amount
...
async def setup_farmer(
    ...
    service_config["ssd_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "ssd")
    service_config["pool_public_keys"] = [bytes(pk).hex() for pk in b_tools.pool_pubkeys]
    service_config["port"] = port
    service_config["rpc_port"] = uint16(0)
    config_pool["ssd_target_address"] = encode_puzzle_hash(b_tools.pool_ph, "ssd")
