...
from ssdcoin.consensus.default_constants import DEFAULT_CONSTANTS, update_testnet_overrides
...
from ssdcoin.server.start_service import RpcInfo, Service, async_run
...
from ssdcoin.util.task_timing import maybe_manage_task_instrumentation
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("SSDCOIN_INSTRUMENT_NODE") is not None):
        ...
        if not service_config.get("use_ssdcoin_loop_policy", True):
            target_peer_count = None
