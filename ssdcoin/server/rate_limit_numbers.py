...
# Version 1 includes the original limits for ssdcoin software from versions 1.0 to 1.4.
rate_limits = {
    1: {
        ...
        "rate_limits_other": {
            ...
            # staking
            ProtocolMessageTypes.request_staking_coefficients: RLSettings(200, 2048),
            ProtocolMessageTypes.respond_staking_coefficients: RLSettings(200, 2048),
        },
    },
    2: {
        "default_settings": RLSettings(100, 1024 * 1024, 100 * 1024 * 1024),
