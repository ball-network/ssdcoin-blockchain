...
from ssdcoin.util.config import get_unresolved_peer_infos, load_config, load_config_cli
...
async def async_main() -> int:
    ...
    if local_test is True:
        from ssdcoin.simulator.block_tools import test_constants
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("SSDCOIN_INSTRUMENT_WALLET") is not None):
