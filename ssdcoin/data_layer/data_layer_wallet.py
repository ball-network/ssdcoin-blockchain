...
class DataLayerWallet:
    ...
    async def delete_mirror(
        self, mirror_id: bytes32, peer: WSSSDCoinConnection, fee: uint64 = uint64(0)
    ) -> List[TransactionRecord]:
        ...
        if excess_fee > 0:
            ssdcoin_tx: TransactionRecord = await self.wallet_state_manager.main_wallet.generate_signed_transaction(
                uint64(1),
                new_puzhash,
