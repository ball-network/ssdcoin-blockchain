...
from ssdcoin.cmds.cmds_util import get_wallet_client, transaction_status_msg, transaction_submitted_msg
                ...
                if confirmation not in ["y", "yes"]:
                    ...
                    with open(pathlib.Path(filepath), "w") as file:
                        ...
                        if offer is not None:
                            ...
                            print(
                                f"Use ssd wallet get_offers --id "
    ...
    *, wallet_rpc_port: Optional[int], fp: Optional[int], fee: Decimal, tx_ids_str: str
    ...
    async with get_wallet_client(wallet_rpc_port, fp) as (wallet_client, _, _):
        ...
        if fee < 0:
            ...
            return
        response = await wallet_client.spend_clawback_coins(tx_ids, int(fee * units["ssdcoin"]))
        print(str(response))
