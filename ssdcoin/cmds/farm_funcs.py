...
async def summary(
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'ssd start wallet' and 'ssd wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'ssd wallet show'")
    else:
        print("Note: log into your key using 'ssd wallet show' to see rewards for each key")
