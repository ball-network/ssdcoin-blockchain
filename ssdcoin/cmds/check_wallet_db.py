...
help_text = """
\b
    The purpose of this command is find potential issues in SSDCoin wallet databases.
    The core ssdcoin client currently uses sqlite to store the wallet databases, one database per key.
\b
