...
from ssdcoin.cmds.cmds_util import NODE_TYPES
from ssdcoin.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified SSDCoin service to ip:port", type=str, default="")
@click.option(
