...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older SSDCoin versions use "
...
@click.option("--prefix", "-x", help="Address prefix (ssd for mainnet, tssd for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
