...
from ssdcoin.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "30188"
                testnet_introducer = "introducer-testnet10.ssdcoin.top"
                testnet_dns_introducer = "dns-introducer-testnet10.ssdcoin.top"
                bootstrap_peers = ["testnet10-node.ssdcoin.top"]
                testnet = "testnet10"
                ...
                mainnet_port = "30088"
                mainnet_introducer = "introducer.ssdcoin.top"
                mainnet_dns_introducer = "dns-introducer.ssdcoin.top"
                bootstrap_peers = ["node.ssdcoin.top"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running ssdcoin services for changes to take effect")
