...
from ssdcoin.cmds.passphrase import passphrase_cmd
from ssdcoin.cmds.peer import peer_cmd
from ssdcoin.cmds.plotnft import plotnft_cmd
from ssdcoin.cmds.plots import plots_cmd
from ssdcoin.cmds.plotters import plotters_cmd
from ssdcoin.cmds.rpc import rpc_cmd
...
from ssdcoin.util.ssl_check import check_ssl
...
def cli(
    ...
    if passphrase_file is not None:
        ...
        from ssdcoin.cmds.passphrase_funcs import cache_passphrase, read_passphrase_from_file
...
@cli.command("version", help="Show ssdcoin version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", help="Runs ssd daemon")
@click.option(
    "--wait-for-unlock",
