...
from ssdcoin.cmds import options
...
@click.option(
    "-m", "--fee", type=str, default=0, show_default=True, help="Blockchain fee for approval transaction, in SSD"
)
...
def find_pool_nft_cmd(
    ...
    from .stake_funcs import find_pool_nft
