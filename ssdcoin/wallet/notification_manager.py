...
from ssdcoin.wallet.notification_store import Notification, NotificationStore
from ssdcoin.wallet.transaction_record import TransactionRecord
from ssdcoin.wallet.util.compute_memos import compute_memos_for_spend
from ssdcoin.wallet.util.notifications import construct_notification
...
class NotificationManager:
    ...
    async def send_new_notification(
        ...
        full_tx: TransactionRecord = dataclasses.replace(
            ssdcoin_tx, spend_bundle=SpendBundle.aggregate([ssdcoin_tx.spend_bundle, extra_spend_bundle])
        )
        return full_tx
