...
from ssdcoin.wallet.singleton import get_inner_puzzle_from_singleton, get_singleton_id_from_puzzle
from ssdcoin.wallet.singleton_record import SingletonRecord
