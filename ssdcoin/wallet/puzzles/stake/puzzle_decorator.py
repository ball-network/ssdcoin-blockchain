...
from ssdcoin.types.stake_value import get_stake_value
...
from ssdcoin.wallet.puzzles.stake.drivers import create_stake_merkle_puzzle
    ...
    def decorate_target_puzzle_hash(
        ...
        return (
            ...
            create_stake_merkle_puzzle(
                get_stake_value(self.stake_type).time_lock, self.recipient_puzzle_hash
            ).get_tree_hash(),
        )
