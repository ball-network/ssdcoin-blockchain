...
from ssdcoin.util.file_keyring import FileKeyring
...
# the new passphrase.
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ ssd passphrase set # all the cool kids are doing it!"

MASTER_PASSPHRASE_SERVICE_NAME = "SSDCoin Passphrase"
MASTER_PASSPHRASE_USER_NAME = "SSDCoin Passphrase"
...
class KeyringWrapper:
    ...
    def _get_initial_cached_passphrase(self) -> str:
        ...
        """
        from ssdcoin.util.keychain import supports_os_passphrase_storage
