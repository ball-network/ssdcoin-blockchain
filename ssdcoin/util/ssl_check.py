...
from ssdcoin.util.config import load_config, traverse_dict
from ssdcoin.util.permissions import octal_mode_string, verify_file_permissions
...
def check_ssl(root_path: Path) -> None:
    ...
    if len(invalid_files):
        ...
        print("Run the following to fix issues: ssd init --fix-ssl-permissions")
