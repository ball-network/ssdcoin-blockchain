...
from ssdcoin.data_layer.data_layer_errors import OfferIntegrityError
...
from ssdcoin.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from ssdcoin.rpc.data_layer_rpc_util import marshal
...
from ssdcoin.util.ws_message import WsRpcMessage
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "ssdcoin_data_layer"
