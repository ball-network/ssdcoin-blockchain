...
from ssdcoin.types.coin_spend import CoinSpend, CoinSpendWithConditions
...
class FullNodeRpcClient(RpcClient):
    """
    Client to SSDCoin RPC, connects to a local full node. Uses HTTP/JSON, and converts back from
