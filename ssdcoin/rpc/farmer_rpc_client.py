...
from ssdcoin.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from ssdcoin.rpc.rpc_client import RpcClient
from ssdcoin.types.blockchain_format.sized_bytes import bytes32
from ssdcoin.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to SSDCoin RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
