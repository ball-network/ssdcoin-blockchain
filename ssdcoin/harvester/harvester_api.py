...
from ssdcoin.plotting.util import PlotInfo, parse_plot_info
from ssdcoin.protocols import harvester_protocol
from ssdcoin.protocols.farmer_protocol import FarmingInfo
from ssdcoin.protocols.harvester_protocol import Plot, PlotSyncResponse
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSSSDCoinConnection
    ) -> None:
        """
