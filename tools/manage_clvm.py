...
root = here.parent
cache_path = root.joinpath(".ssdcoin_cache", "manage_clvm.json")
...
from ssdcoin.types.blockchain_format.serialized_program import SerializedProgram  # noqa: E402
...
top_levels = {"ssdcoin"}
hashes_path = root.joinpath("ssdcoin/wallet/puzzles/deployed_puzzle_hashes.json")
std_libraries = root.joinpath("ssdcoin/wallet/puzzles")
...
main(auto_envvar_prefix="SSDCOIN_MANAGE_CLVM")
