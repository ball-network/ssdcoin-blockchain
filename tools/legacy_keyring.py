"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of ssdcoin-blockchain. To use this
...
from ssdcoin.util.errors import KeychainUserNotFound
from ssdcoin.util.keychain import KeyData, KeyDataSecrets, get_private_key_user
...
DEFAULT_USER = f"user-ssdcoin-{CURRENT_KEY_VERSION}"  # e.g. user-ssdcoin-1.8
DEFAULT_SERVICE = f"ssdcoin-{DEFAULT_USER}"  # e.g. ssdcoin-user-ssdcoin-1.8
MAX_KEYS = 100
