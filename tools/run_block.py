...
"""
run_block: Convert an encoded FullBlock from the SSDCoin blockchain into a list of transactions

As input, takes a file containing a [FullBlock](../ssdcoin/types/full_block.py) in json format
...
$ca_root is the directory containing your current SSDCoin config files
$hash is the header_hash of the [BlockRecord](../ssdcoin/consensus/block_record.py)
...
The information for each spend is an "NPC" (Name, Puzzle, Condition):
        ...
        "conditions": a list of condition expressions, as in [condition_opcodes.py](../ssdcoin/types/condition_opcodes.py)
...
from ssdcoin.wallet.cat_wallet.cat_utils import match_cat_puzzle
