...
export SSDCOIN_INSTALLER_VERSION
...
pip install j2cli
CLI_DEB_BASE="ssdcoin-blockchain-cli_$SSDCOIN_INSTALLER_VERSION-1_$PLATFORM"
...
GUI_DEB_NAME=ssdcoin-blockchain_${SSDCOIN_INSTALLER_VERSION}_${PLATFORM}.deb
mv "dist/${PRODUCT_NAME}-${SSDCOIN_INSTALLER_VERSION}.deb" "../../../build_scripts/dist/${GUI_DEB_NAME}"
