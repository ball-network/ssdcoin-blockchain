...
rm -rf ../venv || true
rm -rf venv || true
rm -rf ssdcoin_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf ssdcoin-blockchain-gui/build || true
rm -rf ssdcoin-blockchain-gui/daemon || true
rm -rf ssdcoin-blockchain-gui/node_modules || true
rm ssdcoin-blockchain-gui/temp.json || true
( cd "$PWD/ssdcoin-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
