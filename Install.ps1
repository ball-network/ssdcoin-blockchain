...
{
    Write-Output "SSDCoin requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "SSDCoin  blockchain .\Install.ps1 complete."
Write-Output "For assistance join us on Discord in the #support chat channel:"
Write-Output "https://discord.gg/ssdcoin"
Write-Output ""
Write-Output "Try the Quick Start Guide to running ssdcoin-blockchain:"
Write-Output "https://github.com/ball-network/ssdcoin-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
Write-Output "To install the GUI run '.\venv\scripts\Activate.ps1' then '.\Install-gui.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'ssd init' to begin."
